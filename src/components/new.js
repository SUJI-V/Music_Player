  ...
  return (
    <>
     ...
     <Icon1 name="arrowleft" size={25} style={{color:'#fff'}} onPress={() => navigation.goBack()}/>
                <Text style={{color:"#fff", fontFamily: "italic", fontWeight: "bold", fontSize: 20,}}>Library</Text>
...
<View style={{height:"100%",width:"30%",flexDirection:"row", flexWrap:"wrap",alignItems:"center", alignContent:"center",justifyContent:"space-between", }}>
                ...
                <IconM name="search" size={30} color="#fff" onPress={() => navigation.navigate('Library')} />
                </View>
                </View>
            </View>
...
<Modal visible={modalOpen} animationType="slide" transparent={true}>
     ...
     <Image source={require('../assets/bg3.jpg')} style={{ position:"absolute", width: "100%", height:"100%"}} />
      ...
      <ScrollView style={{backgroundColor:'#376f8acd',height:"90%"}}>
