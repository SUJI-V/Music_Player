    ...
    <ScrollView>
      <View style={{height: 820}}>
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', top: 20, left: 10}}>
            Recomended
          </Text>
          <Image
            source={require('../assets/ads/1.jpg')}
            style={{height: 50, width: 50, borderRadius: 25, top: 35, left: 10}}
          />
          <Text style={{left: 10, top: 38, fontStyle: 'italic', fontSize: 12}}>
            Music Player
          </Text>
          <Image
          ...
          />
          <Text
            style={{left: 125, top: -27, fontSize: 12, fontStyle: 'italic'}}>
            HD Camera
          </Text>
          <Image
          ...
          />
          <Text style={{left: 210, top: -102, fontSize: 12}}>
            Photo Slideshow
          </Text>
          <Image
        ...
        <View
          ...
          <Text style={{fontWeight: 'bold', left: 10, top: 10}}>
            Top Rated Apps
          </Text>
          <Image
          ...
          />
          <Text style={{left: 225, top: -195, fontSize: 12}}>
            Phone Cleaner
          </Text>
          <Image
            source={require('../assets/ads/cam.jpg')}
            style={{
              height: 50,
              width: 50,
              borderRadius: 25,
          ...
          <Image
            source={require('../assets/ads/cutter.png')}
            style={{
              height: 50,
              width: 50,
              borderRadius: 25,
          ...
          />
          <Text style={{left: 118, top: -210, fontSize: 12}}>
            Ringtone Cutter
          </Text>
          <Image
            source={require('../assets/ads/player.jpg')}
            style={{
              height: 50,
              width: 60,
              borderRadius: 25,
        ...
        <View
          ...
          <Image
            ...
            style={{height: 50, width: 50, borderRadius: 15, top: 20, left: 20}}
          />
          ...
          />
          <Text style={{left: 218, top: -110, fontSize: 12}}>
            Bubble Shooter
          </Text>
        </View>
      </View>
